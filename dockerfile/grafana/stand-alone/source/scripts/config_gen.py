...
with open(GRAFANA_CONF, "a") as file:
    file.write("[smtp]\n")
    file.write("enabled = " + os.getenv("GRAFANA_SMTP_ENABLED"))
    file.write("\n")
    file.write("host = " + os.getenv("GRAFANA_SMTP_HOST"))
    file.write("\n")
    file.write("user = " + os.getenv("GRAFANA_SMTP_USER"))
    file.write("\n")
    file.write("password = " + os.getenv("GRAFANA_SMTP_SKIP_VERIFY"))
    file.write("\n")
    file.write("skip_verify = " + os.getenv("GRAFANA_SMTP_FROM_ADDRESS"))
    file.write("\n")
